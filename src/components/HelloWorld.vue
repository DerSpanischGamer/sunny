<template>
  <div class="hello">
    <h1>{{ msg }}</h1> <br>
    <h2>Bienvenue au Sunny! Le site de vente de voiture le plus spécialisé d'internet. <br><img src="../assets/car.png" height="100" > Ici vous trouverez en un clignotement d'oeil la voiture de vos rêves.</h2> <br>
    <v-carousel >
